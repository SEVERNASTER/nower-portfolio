...
export const ModernPortfolioTemplate: React.FC<PortfolioTemplateProps> = ({ user }) => {
  return (
    <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
      ...
      <main className="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl dark:border-slate-800 dark:bg-[#17262C]">
        <PortfolioContentSections user={user} />
      </main>
    </div>
  );
};
    ...
    <div className="rounded-[2rem] bg-gradient-to-br from-purple-100 via-white to-emerald-100 p-4 shadow-xl dark:from-purple-950/40 dark:via-[#17262C] dark:to-emerald-950/40">
      <div className="rounded-[1.5rem] bg-white/80 p-6 backdrop-blur dark:bg-slate-950/50">
        <div className="mb-8 text-center">
          ...
          <div className="mt-5 flex flex-wrap justify-center gap-3 text-sm text-slate-500 dark:text-slate-400">
            {user?.city && (
              <span className="flex items-center gap-1 rounded-full bg-white px-3 py-1 shadow-sm dark:bg-slate-900">
        ...
        <div className="rounded-3xl bg-white p-6 shadow-lg dark:bg-[#17262C]">
          <PortfolioContentSections user={user} />
        </div>
      </div>
    </div>
