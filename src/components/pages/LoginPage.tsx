        ...
        <div className="relative w-full lg:w-1/2 flex-1 h-full overflow-hidden p-8 sm:p-10 lg:p-14 flex flex-col justify-center bg-slate-50 dark:bg-gradient-to-br from-[#120F1A] via-[#171E2F] to-[#120F1A] lg:bg-white lg:dark:bg-[#08180d] transition-colors">
          ...
          <div className="relative z-10 w-full max-w-md mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 w-full rounded-xl border border-slate-300 dark:border-slate-800 bg-white dark:bg-[#111827] py-3 text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
